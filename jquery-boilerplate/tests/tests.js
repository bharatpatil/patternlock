...
testOptionGroup1();
testOptionGroup1({rows:4,columns:4});
testOptionGroup1({rows:4,columns:2});
testOptionGroup1({width:300});
testOptionGroup1({height:300});
testOptionGroup1({width:300,height:400});
testOptionGroup1({rows:2,column:3,width:300,height:400});
testOptionGroup1({fieldName:"pattern"});
testOptionGroup1({rows:2,column:4,width:400,height:500,fieldName:"testHiddenField"});
